		...
		<div class="gridSearch">
			...
			<table class="tab">
				...
				<tr class="bor">
					<th>描述：</th>
					<td colspan="3">
					<textarea id="rolenote" name="rolenote" class="intextarea" style="height: 100px;"></textarea>
					</td>
				</tr>
			</table>
			</form>
...
$(document).ready(function(){
	$.ajax({
    	url: "${pageContext.request.contextPath}/roleInfoController/getTreeMenu.do",
        type: 'POST',
        async:false,
	    dataType: "JSON",
...
function submitForm(){
	...
	$("#roleInfoFrom").form("submit", {
	    url:"${pageContext.request.contextPath}/roleInfoController/saveRoleInfoDatas.do",
	    dataType: "JSON",
	    onSubmit: function(){
